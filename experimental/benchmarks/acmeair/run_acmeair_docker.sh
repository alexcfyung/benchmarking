...
NODE_UNDERTEST=$CURRENT_DIR/nd/node_undertest/bin
chmod u+x ${NODE_UNDERTEST}/node
NODE_BASELINE=$CURRENT_DIR/nd/node_baseline/bin
...
#pushd $CURRENT_DIR/benchmarking/experimental/benchmarks/acmeair
echo "Running build:"
